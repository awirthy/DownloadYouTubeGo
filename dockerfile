...
RUN wget -O /tmp/DownloadYouTubeGo.tar.gz https://github.com/awirthy/DownloadYouTubeGo/archive/refs/tags/v1.00.tar.gz
...
RUN echo "/opt/DownloadYouTubeGo/DownloadYouTubeGo-1.00/DownloadYouTubeGo.sh" >> /etc/periodic/15min/DownloadYouTubeGo
RUN chmod 755 /opt/DownloadYouTubeGo/DownloadYouTubeGo-1.00/DownloadYouTubeGo.sh
